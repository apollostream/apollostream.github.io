...
I also had Perplexity.AI generate a chronology centered around six key authors connected to the Harlem Renaissance, and to generate a visualization, shown below. I can't speak to its accuracy or completeness -- I simply haven't paid the dues of diligent scholarship needed to speak authoritatively on this subject. So take this as a starter sketch to kick you off with the gist of how these figures tied together but be aware that it could be misleading with respect to who is emphasized and who is not and what works are mentioned and what are not.

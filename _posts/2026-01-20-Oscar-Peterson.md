...
By the way, per the BFIH web app: I've worked a lot with Anthropic's Claude Code to improve the app's formation of hypotheses, assignment of priors and likelihoods, and writing of engaging yet still accurate and information-dense synopses.  The synopsis below comes from the app employing OpenAI's GPT-5.2 -- the first one done without Perplexity AI in the mix at all. 

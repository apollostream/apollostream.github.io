...
When I read that just flexing your abs now and then was a great way to "cleanse your brain" and stave off dimentia, I was intrigued. That's an easy intervention to inject into my everyday life. And, the payoff could be great. Amazing!
...
> **_"Abdominal movement literally cleans the brain."_**

**The upshot:** "Not proven, yet".
...
<object
  data="{{ '/assets/pdf/Abs-Brain-Cleanse_synopsis_atlantic.pdf' | relative_url }}"
  type="application/pdf"
  width="100%"
  height="800"
>
  <iframe
    src="{{ '/assets/pdf/Abs-Brain-Cleanse_synopsis_atlantic.pdf' | relative_url }}"
    width="100%"
    height="800"
    style="border:0;"
  >
    <p>
      ...
      <a href="{{ '/assets/pdf/Abs-Brain-Cleanse_synopsis_atlantic.pdf' | relative_url }}">Download the PDF instead</a>.
    </p>
  </iframe>
</object>

...
> **_"El Paso is undergoing a crisis as its non-white American citizens are stopped and taken into custody by ICE without cause."_**

**The upshot:** Yes, to an extent but it's not a simple issue.
...
{% include ElPaso-ICE-auto_0724960f_synopsis-include.md %}
